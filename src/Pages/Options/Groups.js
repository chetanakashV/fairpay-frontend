...
import {Add, MoreVert, Paid, Info, Delete, Analytics} from '@mui/icons-material'
...
const Groups = () => {
    ...
    const [extraContainer, setExtraContainer] = useState(false);
    ...
    const handleGroupMenu = () => {
       if(!groupMenuOptions) setGroupMenuOptions(true)
       else setGroupMenuOptions(false)
    }
    ...
    const addNewGroup = (res) => {
        ...
        setGroups((prevUsers) => {
            const groupExists = prevUsers.some(user =>
              user[3] === newItem[3]
            );
            ...
            >
             ...
             <div className={bar? "group-container-closed": "group-container"}>
                 <div className="group-name-container">
                   ...
                   {!showPop && !showExpensePop  &&  <Add className="create-group-icon" onClick = {
                        () => {
                            setShowPop(true)
                        }}
                        />}
                  ...
                  <div className={groupMenu?"group-details-container-closed": "group-details-container"}>
                        <div className="group-details-heading">
                            <div className="group-details-container1">
                             <img src = {selectedGroup.groupPhoto} height="80%" style={{
                                borderRadius: "50px"
                             }}/>
                            </div>
                            ...
                            <div className="group-details-container3">
                                    <div>
                                     ...
                                     onClick={handleGroupMenu}
                                      style={{
                                        transform: "scale(1.5)",borderRadius: "2px", cursor: "pointer"
                                     }}/>
                                     {groupMenuOptions && <div
                                      className="more-verti-options" >
